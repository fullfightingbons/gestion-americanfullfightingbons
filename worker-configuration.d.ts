...
// NOTE: bindings ci-dessous resynchronisés manuellement avec wrangler.json + secrets CF.
// Si wrangler.json change, relancer `npm run cf-typegen` puis réappliquer ce bloc.
declare namespace Cloudflare {
	...
	interface Env {
		...
		R2_PDF: R2Bucket;
		ASSETS: Fetcher;
		/** Cloudflare Worker secret — set via `wrangler secret put SESSION_SECRET` */
